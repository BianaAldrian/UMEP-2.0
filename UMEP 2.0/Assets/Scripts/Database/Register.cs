...
public class Register : MonoBehaviour
{
    ...
    public TMP_InputField id_number, mobile_number, password;
    ...
    void CheckInputs()
    {
        ...
        {
            // Inputs are not empty, you can proceed with your registration logic here
            CheckUser();
        }
    }
    ...
    void CheckUser()
    {
        ...
        {
            Debug.Log("Connected");
            StartCoroutine(CheckUserCoroutine(serverIP));
        }
    }
