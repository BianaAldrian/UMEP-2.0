        ...
        private void Setup()
        {
            ...
            switch (placement)
            {
                case Placement.Left:
                    ...
                    pivot = new Vector2(0, 0.5f); // Set pivot to the left side
                    closedPosition = new Vector2(-rectTransform.rect.width, rectTransform.localPosition.y); // Move panel off-screen to the left
                    openPosition = new Vector2(0, rectTransform.localPosition.y); // Position panel at (0, 0)
                    break;
                case Placement.Right:
